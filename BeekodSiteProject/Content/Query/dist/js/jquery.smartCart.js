...
;(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        cartItemTemplate: '<img class="img-responsive pull-left" /*src="{product_image}"*/ /><h4 style="margin-bottom: -2.5rem" class="list-group-item-heading">{product_name}</h4><p class="list-group-item-text">{product_desc}</p>',
        ...
        lang: { // Language variables
            ...
            cartRemove: '×',
            cartEmpty: 'Sepet bos!<br />Urun Ekleyiniz'
        },
        submitSettings: {
    ...
    $.extend(SmartCart.prototype, {
        ...
        _addUpdateCartItem: function (p) {
            p[this.options.paramSettings.productPrice] = p[this.options.paramSettings.productPrice].replace(',', '.');
            var productAmount = (p[this.options.paramSettings.productQuantity] - 0) * (p[this.options.paramSettings.productPrice] - 0);
           // var productAmount = (aa.replace(',','.') *bb);
